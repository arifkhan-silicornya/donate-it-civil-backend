    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mother_name', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('PhoneDialCode', models.CharField(blank=True, max_length=10, null=True)),
                ('countryName', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createDate', models.CharField(default='08/31/23 04:41:15', max_length=300)),
                ('expiredDate', models.CharField(default='08/31/23 04:56:15', max_length=300)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
