...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    father_name=models.CharField(max_length=10,null=True,blank=True)
    mother_name=models.CharField(max_length=10,null=True,blank=True)
    ...
    PhoneDialCode=models.CharField(max_length=10,null=True,blank=True)
    countryName=models.CharField(max_length=10,null=True,blank=True)
...
class EducationalQualification(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE )
    institute_name = models.BooleanField(default=False,null=True)
