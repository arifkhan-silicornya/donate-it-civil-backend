...
class footerHeadOffice(models.Model):
    ...
    usa_address = models.CharField(max_length= 300,blank = False)
    usa_email = models.EmailField(max_length= 300,blank = False)
    usa_phone = models.CharField(max_length= 300,blank = False)
    usa_fax = models.CharField(max_length= 300,blank = False)
    uk_address = models.CharField(max_length= 300,blank = False)
    uk_email = models.EmailField(max_length= 300,blank = False)
    uk_phone = models.CharField(max_length= 300,blank = False)
    uk_fax = models.CharField(max_length= 300,blank = False)
    active=models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    last_update_at = models.DateTimeField(auto_now=True)
