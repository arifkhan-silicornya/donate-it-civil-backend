    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', models.CharField(blank=True, max_length=300, null=True)),
                ('total_online_paid', models.CharField(blank=True, max_length=300, null=True)),
                ('total_offline_paid', models.CharField(blank=True, max_length=300, null=True)),
