...
SECRET_KEY = 'django-insecure-gsyv+3vg$qn!8i*b#@60eui_ysh@^c31l##vyd0rw-ntr10b!t'
...
AUTHENTICATION_BACKENDS = ['Authentication.backend.UsernameOrEmail']
...
# EMAIL_HOST_PASSWORD='Mastermind123@@'
